<template>
  <div class="template_div">
    <addpatient
      v-if="addpatient.addpatient_show"
      :addpatient_show="addpatient.addpatient_show"
      :adddoctor_dialogRow="addpatient.addpatient_dialogRow"
      @getPatient_List="getPatientList"
      @closeadd_doctorDialog="hideAddPatientDialog"/>
    <el-row>
      <!-- 房间号 -->
      <el-form :inline="true"  class="demo-form-inline">
        <el-form-item class="el_form_item_fang_add_buton">
          <el-button type="info" plain  class="el_button_add_fang"
                     v-on:click="addPatient">{{$t('fang_Room.add')}}</el-button>
        </el-form-item>
        <!-- 房间编号 -->
        ...
        <el-table-column
          ...
          <template slot-scope='scope'>
            <el-button
              ...
              icon='edit'
              size="mini"
              @click='onEditMoneyPatient(scope.row)'
            ...
            <el-button
              ...
              icon='delete'
              size="mini"
              v-on:click="deletePatientbyid(scope.row.fid)"
...
<style src="../css/patientlist.css"></style>
